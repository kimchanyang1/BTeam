...
<body>
<h2 align="center">분양/임시보호 게시글 등록</h2>
<br>
<form class="form-horizontal" action="rehomeinput" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
    	<label class="control-label col-sm-2" for="rh_title">제목</label>
	    	<div class="col-sm-10">
	    		<input type="text" name="rh_title" class="form-control" id="rh_title">
	    	</div>
    </div>
    <div class="form-group">
    	<label class="control-label col-sm-2" for="rh_pname">반려동물 이름</label>
    		<div class="col-sm-10">
    			<input type="text" name="rh_pname" class="form-control" id="rh_pname">
    		</div>
    </div>
    <div class="form-group">
    	<label class="control-label col-sm-2" for="rh_pno">반려동물 등록번호</label>
    		<div class="col-sm-10">
    			<input type="text" name="rh_pno" class="form-control" id="rh_pno">
    		</div>
    </div>
    <div class="form-group">
    	<label class="control-label col-sm-2" for="rh_misdate">반려동물 발견날짜</label>
    		<div class="col-sm-10">
    			<input type="date" name="rh_misdate" class="form-control" id="rh_misdate">
    		</div>
    </div>
    <div class="form-group">
    	<label class="control-label col-sm-2" for="rh_misplace">반려동물 발견장소</label>
    		<div class="col-sm-10">
    			<input type="text" name="rh_misplace" class="form-control" id="rh_misplace">
    		</div>
    </div>
    <div class="form-group">
    	<label class="control-label col-sm-2" for="rh_image">반려동물 이미지</label>
    		<div class="col-sm-10">
    			<input type="file" name="rh_image" class="form-control" id="rh_image">
    		</div>
    </div>
    <div class="form-group">
    	<label class="control-label col-sm-2" for="rh_content">글 내용</label>
    		<div class="col-sm-10">
    			<textarea class="form-control" rows="20" name="rh_content" id="rh_content" placeholder="(필수: 품종, 색상, 크기, 성별, 나이 / 사고 경위 등을 작성해 주세요)"></textarea>
    		</div>
    </div>
