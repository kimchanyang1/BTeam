...
<div class="terms_p">
	...
	<p class="terms_chk_all col-sm-offset-3 col-sm-6">
		<span class="input_chk">
			...
			<label for="chk_all"><span class="chk_all_txt">네이버 이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택)에 모두 동의합니다.</span></label>
		</span>
	</p>
	<!-- 종료: 한꺼번에 체크하기 -->
...
다양한 네이버 서비스를 즐겨보세요.
네이버는 www.naver.com을 비롯한 네이버 도메인의 웹사이트을 통해 정보 검색, 다른 이용자와의 커뮤니케이션, 콘텐츠 제공 등 여러분에게 다양한 서비스를 제공하고 있습니다.
...
네이버는 기본적으로 여러분 모두에게 동일한 내용의 서비스를 제공합니다. 다만, '청소년보호법' 등 관련 법령이나 기타 개별 서비스 제공에서의 특별한 필요에 의해서 일정한 등급을 기준으로 이용자를 구분하여 제공하는 서비스의 내용 등을 다르게 하는 등 일부 이용을 제한하는 경우가 있습니다. 자세한 내용은 역시 각 서비스 상의 안내, 공지사항, 고객센터 도움말 등에서 확인하실 수 있습니다.
...
네이버는 여러분이 게재한 게시물이 네이버 서비스를 통해 다른 이용자들에게 전달되어 우리 모두의 삶을 더욱 풍요롭게 해줄 것을 기대합니다. 게시물은 여러분이 타인 또는 자신이 보게 할 목적으로 네이버 서비스 상에 게재한 부호, 문자, 그림, 사진 등으로 구성된 각종 콘텐츠 자체 또는 파일을 말합니다.
...
한편, 네이버 서비스를 매개로 한 여러분과 다른 회원 간 또는 여러분과 비회원 간의 의견 교환 등에서 발생한 손해나 여러분이 서비스 상에 게재된 타인의 게시물 등의 콘텐츠를 신뢰함으로써 발생한 손해에 대해서도 네이버는 특별한 사정이 없는 한 이에 대해 책임을 부담하지 않습니다.
...
<!-- 시작: 에러 메세지, 세 개다 체크를 해 주세요 -->
	<div>   
		<font color="red"><B>
		<span class="error" id="agreeMsg" style="display:none">네이버 이용약관과 개인정보 수집 및 이용에 대한 안내 모두 동의해주세요.</B></font></span>
	</div>
