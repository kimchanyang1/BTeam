...
<tr>
	...
	<tr><td colspan="4" align="center" bgcolor="#fbdee2"><B>　반려동물 정보　</B></td></tr>
...
<tr>
	...
	<textarea id="detailarea" readonly="readonly">
	${mic.mis_content }
	</textarea>
	</td>
	<td>　　　　</td>
	...
	<td colspan="4" align="right">
		<c:if test="${mem_nickname eq mic.mem_nickname || mem_id eq 'admin'}">
				...
				<c:if test="${mic.mis_gb eq '귀가'}">
					<button onclick="location.href='epilogueinputform?ep_gb=귀가완료&ep_originno=${mic.mis_no}'"><B>후기글쓰기</B></button>
				</c:if>
		</c:if>
	</td>
	</tr>		
